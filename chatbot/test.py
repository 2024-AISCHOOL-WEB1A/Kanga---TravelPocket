...
# Function to interact with the EEVE model
def eeve_chat(user_input, system_message, vault_embeddings, vault_content, model):
    ...
    # Send the completion request to the EEVE model
...
response = eeve_chat(user_input, system_message, vault_embeddings_tensor, vault_content, model)
